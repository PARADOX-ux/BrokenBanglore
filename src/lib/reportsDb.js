...
export async function submitReport(reportData) {
  ...
  const record = { 
    ...
    lat: reportData.lat ? Number(reportData.lat) : null,
    lng: reportData.lng ? Number(reportData.lng) : null,
    area_name: reportData.area_name || reportData.area || reportData.wardData?.name,
    ward_no: reportData.ward_no ? Number(reportData.ward_no) : (reportData.wardData?.ward ? Number(reportData.wardData.ward) : null),
    ...
    mp_constituency: reportData.wardData?.mpConstituency,
